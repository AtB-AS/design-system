...
const themes: Themes = {
    light: {
      ...
      colors: {
        ...
        background_accent: contrastColor("#026D86", 'light'),
        primary_1: contrastColor('#F583A5', 'dark'),
        primary_2: contrastColor("#007C92", 'light'),
        primary_3: contrastColor(colors.secondary.cyan_500, 'dark'),
        primary_destructive: contrastColor('#8F2F29', 'light'),
        secondary_1: contrastColor(colors.primary.gray_500, 'light'),
        secondary_2: contrastColor("#AFB3B7", 'dark'),
        secondary_3: contrastColor('#B6DEE7', 'dark'),
        secondary_4: contrastColor(colors.primary.gray_50, 'dark'),

        transport_city: contrastColor("#026D86"),
      ...
      status: {
        ...
        info: {
          main: contrastColor('#B6DEE7', 'dark'),
          bg: contrastColor(hexToRgba('#B6DEE7', 0.25), 'dark'),
        },
        warning: {
          main: contrastColor('#FEEAD0', 'dark'),
          bg: contrastColor(hexToRgba('#FEEAD0', 0.25), 'dark'),
        },
        error: {
