...
export const baseColors = {
  ...
  red_100: contrastColor('#F7DCDC', 'dark'),
  red_200: contrastColor('#EEB7B7', 'dark'),
  red_300: contrastColor('#C91717', 'dark'),
  red_400: contrastColor('#B51515', 'dark'),
  red_500: contrastColor('#A11212', 'dark'),
  red_600: contrastColor('#971111', 'light'),
  red_700: contrastColor('#790E0E', 'light'),
  red_800: contrastColor('#5A0A0A', 'light'),
  red_900: contrastColor('#460808', 'light'),
};
